    ...
    <div className="font-display bg-background-light text-[#121614] min-h-screen flex flex-col">
      ...
      <header className="w-full bg-white border-b border-[#dde3e0] px-4 md:px-10 lg:px-40 py-4 flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-bold tracking-tight">Smart Waste Platform</h1>
        </div>
        <div className="hidden sm:block">
          <a className="text-sm font-semibold text-primary hover:underline cursor-pointer" onClick={handleLogin}>
        ...
        <div className="w-full max-w-150 bg-white rounded-xl shadow-xl border border-[#dde3e0] overflow-hidden">
          ...
          <div className="px-8 pt-10 pb-6 text-center">
            ...
            <p className="text-base text-[#6a8174]">
              Register to start submitting waste pickup requests and earning rewards.
            </p>
          </div>
          ...
          <form className="px-8 pb-10 space-y-5">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-sm font-medium text-[#121614]">Full Name *</label>
              <input 
            ...
            {/* Email Address */}
            <div className="flex flex-col gap-2">
              <label className="text-sm font-medium text-[#121614]">Email Address *</label>
              <input 
                className="w-full h-12 px-4 rounded-lg border border-[#dde3e0] bg-white focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-[#6a8174]" 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                <label className="text-sm font-medium text-[#121614]">Create Password *</label>
                <input 
                  className="w-full h-12 px-4 rounded-lg border border-[#dde3e0] bg-white  focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-[#6a8174]" 
              ...
              <div className="flex flex-col gap-2">
                <label className="text-sm font-medium text-[#121614] ">Confirm Password *</label>
                <input 
                  className="w-full h-12 px-4 rounded-lg border border-[#dde3e0]  bg-white  focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-[#6a8174]" 
            ...
            {/* Pickup Address */}
            <div className="flex flex-col gap-2">
              <label className="text-sm font-medium text-[#121614] ">Pickup Address *</label>
              <textarea 
            ...
            <div className="flex items-start gap-3 pt-2">
              <input 
                ...
                type="checkbox"
              />
              <label className="text-sm text-[#6a8174]  leading-relaxed" htmlFor="terms">
            ...
            <div className="text-center pt-4">
              <p className="text-sm text-[#6a8174] ">
                Already part of the platform? <a className="text-primary font-bold hover:underline cursor-pointer" onClick={handleLogin}>Log in to your account</a>
              </p>
            </div>
          </form>
        </div>
