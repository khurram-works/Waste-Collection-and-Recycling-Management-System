            ...
            {currentView === "list" && (
              <div className="flex flex-1 gap-6 overflow-hidden">
                ...
                <aside className="w-80 shrink-0 flex flex-col gap-4">
                  <div className="bg-white border border-[#dde3e0] rounded-xl shadow-sm overflow-hidden flex flex-col h-full">
                    {/* Panel Header */}
            ...
            <div className="bg-white p-4 rounded-xl border border-[#dde3e0] shadow-sm flex flex-wrap items-end gap-4 mb-6">
              <div className="flex-1 min-w-50">
                ...
                <div className="relative">
                  ...
                  <input
                    className="w-full pl-10 pr-4 py-2 bg-[#f6f8f7] border-2 border-[#dde3e0] rounded-lg focus:ring-primary focus:border-primary text-sm"
              ...
              <div className="flex-1 min-w-35">
                ...
                <input
                  className="w-full py-2 bg-[#f6f8f7] border-2 border-[#dde3e0] rounded-lg focus:ring-primary focus:border-primary text-sm"
                  type="date"
                />
              </div>
              <div className="flex-1 min-w-35">
              ...
              <div className="flex-1 min-w-35">
                ...
                <select className="w-full py-2 bg-[#f6f8f7] border-2 border-[#dde3e0] rounded-lg focus:ring-primary focus:border-primary text-sm">
