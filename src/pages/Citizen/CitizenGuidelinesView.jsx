    ...
    <main className="flex-1 flex flex-col p-4 md:p-8 lg:p-12 gap-8 overflow-y-auto">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-[#6a8174] text-base md:text-lg max-w-2xl">
          Follow these instructions to ensure your waste is processed correctly and you earn the
          highest rates for every collection.
        </p>
      </div>
        ...
        <div className="flex gap-4 items-start">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-[#6a8174] text-base leading-relaxed max-w-xl">
              Keep it <strong>CLEAN, DRY, and SEPARATED</strong>. Contaminated items reduce the
              value of your entire collection and may lead to pickup rejection.
            </p>
          </div>
        </div>
      ...
      <section className="flex flex-col gap-6">
        <h2 className="text-[#121614] text-2xl font-bold">Material Preparation Guides</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          ...
          <div className="bg-[#f8f9f8] border border-gray-200 rounded-xl overflow-hidden shadow-sm flex flex-col h-full opacity-90">
            ...
            <div className="p-6 flex flex-col gap-4 grow">
              <div className="flex flex-wrap gap-2">
                <span className="px-2 py-1 bg-white rounded text-xs font-semibold">Food Waste</span>
                <span className="px-2 py-1 bg-white rounded text-xs font-semibold">Plastic Bags</span>
                <span className="px-2 py-1 bg-white rounded text-xs font-semibold">Glass</span>
                <span className="px-2 py-1 bg-white rounded text-xs font-semibold">Textiles</span>
              </div>
              <div className="mt-2 p-3 bg-red-50 border border-red-100 rounded-lg">
                <p className="text-xs text-red-700 leading-normal font-medium">
                  <strong>Note:</strong> These items contaminate recycling batches. Dispose of food
                  waste through composting. Plastic bags are not currently accepted for payout.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="mt-auto pt-8 border-t border-[#dde3e0]">
        <div className="bg-white border border-[#dde3e0] p-6 rounded-xl flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex flex-col text-center sm:text-left">
            <p className="text-lg font-bold text-[#121614]">Ready to recycle right?</p>
            <p className="text-sm text-[#6a8174]">Your bins look sorted and ready for collection!</p>
          </div>
          <button className="w-full sm:w-auto flex items-center justify-center gap-3 px-8 py-4 bg-primary text-white text-base font-bold rounded-lg shadow-lg hover:bg-primary/90 transition-all hover:scale-[1.02] active:scale-[0.98]">
            <span className="material-symbols-outlined">add_task</span>+ Submit a New Pickup Request
          </button>
        </div>
      </div>
    </main>
