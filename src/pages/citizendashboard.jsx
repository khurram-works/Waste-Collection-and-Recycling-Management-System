...
//                 <a
//                   className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors ${citizendashboard === "Dashboard" ? "bg-primary text-white" : "bg-white text-[#121614] hover:bg-background-light"}`}
//                   onClick={() => {
...
//                 </a>
//                 <a
//                   className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors ${citizendashboard === "Request" ? "bg-primary text-white" : "bg-white text-[#121614] hover:bg-background-light"}`}
//                   onClick={() => {
...
//                 </a>
//                 <a
//                   className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors ${citizendashboard === "RequestStatus" ? "bg-primary text-white" : "bg-white text-[#121614] hover:bg-background-light"}`}
//                   onClick={() => {
...
//                 </a>
//                 <a
//                   className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors ${citizendashboard === "Earnings" ? "bg-primary text-white" : "bg-white text-[#121614] hover:bg-background-light"}`}
//                   onClick={() => {
...
//                 </a>
//                 <a
//                   className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors ${citizendashboard === "Guidelines" ? "bg-primary text-white" : "bg-white text-[#121614] hover:bg-background-light"}`}
//                   onClick={() => {
...
//                 <a
//                   className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors ${citizendashboard === "Profile" ? "bg-primary text-white" : "bg-white text-[#121614] hover:bg-background-light"}`}
//                   onClick={() => {
